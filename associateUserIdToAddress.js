...
const associateUserIdToAddress = async (userId, userAddress, signedOauthToken, signature) => {
	console.log('signature in associate', signature)
	...
	return axios.post(process.env.OZ_USER_REGISTRATION_AUTOTASK_URL, { userId, userAddress }, { headers: { 'x-authorization': signedOauthToken, 'signature': signature } });
};
